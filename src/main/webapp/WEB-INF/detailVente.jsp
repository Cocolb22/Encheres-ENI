...
<body>
    ...
    <div class="container transparent-card p-4">
        ...
        <div class="mb-3 mt-4 ps-2 element retrait">
            ...
            <div class="p-3">
                <p>
                    <span style="font-weight: bold;">Rue :</span> ${articleVendu.pointRetrait.rue}
                </p>
                <p>
                    <span style="font-weight: bold;">Code Postal :</span> ${articleVendu.pointRetrait.codePostal}
                </p>
                <p>
                    <span style="font-weight: bold;">Ville :</span> ${articleVendu.pointRetrait.ville}
                </p>
            </div>
        </div>
        <div class="mb-3 ps-2 element">
