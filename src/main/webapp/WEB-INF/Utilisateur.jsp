	...
	<div class="transparent-card">
	    ...
	    <form action="UtilisateurServlet" method="post">
	        ...
	        <div class="text-center">
	            <button type="submit" class="btn btn-primary m-2" name="modifier">Modifier</button>
	            <button type="submit" class="btn btn-primary m-2" name="supprimer">Supprimer</button>
	        </div>
	    </form>
	</div>
</div>
